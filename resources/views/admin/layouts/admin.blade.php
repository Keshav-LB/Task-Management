...
<body class="bg-gray-200 font-family-karla flex">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                <div x-show="isOpen" class="absolute w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
                    ...
                    <a href="mailto:keshavmishra1001@gmail.com" class="block px-4 py-2 account-link hover:text-white">Support</a>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
        ...
        <footer class="w-full bg-white text-right p-4">
            Designed for <a target="_blank" href="https://webworksco.in/" class="underline">WebWorks Co.</a> |
            Developed by <a target="_blank" href="https://www.linkedin.com/in/keshavmishra10/" class="underline">Keshav
                Mishra</a>.
        </footer>
    </div>
